...
class UploadHandler
{
    ...
    public function convert_to_eot($files) {
    		
				foreach($files as $file) {
					$cmd = 'curl --i --X POST "https://ofc.p.mashape.com/directConvert/" --header "X-Mashape-Authorization:oV5LIe0xbxjq2UqTDHdNmIO401OiVMl1" -F format=eot -F file=@"'.$file.'" > http://premiumweddingthemes.com/testing/wp-admin/admin.php?page=upload_fonts&test=1';
					exec($cmd,$result);
				}
